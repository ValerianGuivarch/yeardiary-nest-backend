import { CreateSkillMagicalRequest } from './CreateSkillMagicalRequest'
import { CreateSkillPhysicalRequest } from './CreateSkillPhysicalRequest'
...
export abstract class CreateSkillRequest {
  ...
  static isMagicalSkillRequest(request: CreateSkillRequest): request is CreateSkillMagicalRequest {
    return request.type === SkillType.MAGICAL
  }

  static isPhysicalSkillRequest(request: CreateSkillRequest): request is CreateSkillPhysicalRequest {
